package com.cy.emotionrain.ui.main;
...
import com.cy.emotionrain.adapter.RcAdapter;
import com.cy.emotionrain.adapter.ScalableCardItemDecoration;
import com.cy.emotionrain.emotionrain.EmotionRainView;
...
public class MainFragment extends Fragment {
    ...
    private void init() {
        ...
        mAdapter.setOnItemClickListener(new RcAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                startRain();
                Glide.with(getContext()).load(datas.get(position))
    ...
    public void startRain(){
        mRainView.startRain(getBitmaps());
    }

    private List<Bitmap> getBitmaps(){
        List<Bitmap> bitmaps = new ArrayList<>();
        bitmaps.add(BitmapFactory.decodeResource(getResources(), R.drawable.cookies));
        bitmaps.add(BitmapFactory.decodeResource(getResources(), R.drawable.pizza));
        bitmaps.add(BitmapFactory.decodeResource(getResources(), R.drawable.pudding));
        bitmaps.add(BitmapFactory.decodeResource(getResources(), R.drawable.sushi));
        return bitmaps;
    }
